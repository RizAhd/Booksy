 ...
 * @author rizla
 */
@WebServlet(name = "LoadCartBooks", urlPatterns = {"/LoadCartBooks"})
public class LoadCartBooks extends HttpServlet {
            ...
            if (sessionCarts != null) {
                if (sessionCarts.isEmpty()) {
                    ...
                    for (Cart sessionCart : sessionCarts) {
                        sessionCart.getBooks().setUser(null);
