...
//             Address address = (Address) ses.getAttribute("address");
//             responseObject.addProperty("lineOne", address.getLineOne());
//                       responseObject.addProperty("lineTwo", address.getLineTwo());
//                       responseObject.addProperty("lineTwo", address.getLineTwo());
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        } else if (!Test.isCodeValid(postalCode)) {
        ...
        } else if (!newPassword.isEmpty() && !Test.isPasswordValid(newPassword)) {
        ...
        } else if (!confirmPassword.isEmpty() && !Test.isPasswordValid(confirmPassword)) {
            responseObject.addProperty("message", "The password must contains at least uppercase, lowecase,"
                    + " number, special character and to be minimum eight characters long!");
